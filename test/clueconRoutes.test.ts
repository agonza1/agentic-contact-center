...
test("GET /cluecon and /cluecon/present render the interactive presentation shells", async () => {
  ...
  assert.match(narrative.body, /\["flow", "voice-evolution", "realtime-problem", "map", "integration", "vad-interruption", "asr-architecture", "asr", "security", "agent", "demo", "tts", "slo", "ecosystem", "proof", "finale"\]/);
  ...
  assert.match(narrative.body, /"slo", "ecosystem", "proof", "finale"/);
