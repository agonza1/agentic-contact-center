...
def collect_identity_node() -> NodeConfig:
    ...
    <section class="section-band slide" data-slide="13" id="proof"><div class="eval-head"><div><span class="kicker">ConversationAgentEvals</span><h2>Different voice agents. One evaluation contract.</h2><p class="subhead">CAE evaluates web voice agents and VoIP/SIP agents through target adapters. This demo uses the Agentic Call Center PoC.</p></div><button id="run-eval" type="button" class="primary">Run ACC target</button></div><div class="eval-progression" aria-label="Cross-target evaluation progression"><div class="eval-step"><small>1 · CAE scenario</small><strong>Cancellation rescue</strong><span>repeatable</span></div><div class="eval-step"><small>2 · Target adapter</small><strong>Web or VoIP</strong><span>ACC PoC in this demo</span></div><div class="eval-step"><small>3 · Simulated call</small><strong id="eval-turn-step">— turns</strong><span>captured</span></div><div class="eval-step"><small>4 · Policy checks</small><strong id="eval-safety-step">— / 4</strong><span>normalized evidence</span></div><div class="eval-step"><small>5 · CAE verdict</small><strong id="eval-verdict-step">ready</strong><span>comparable</span></div></div><div class="eval-main"><article class="eval-verdict" id="eval-verdict"><small>ACC target result</small><b id="eval-verdict-label">READY</b><strong id="eval-verdict-title">Run the ACC target.</strong><p id="eval-verdict-detail">ACC produces the local safety scorecard and a CAE-compatible evidence bundle for evaluation and comparison.</p></article><div class="eval-checks" id="eval-scorecard" aria-label="Checks supporting the verdict"></div></div><div class="eval-summary"><div class="eval-summary-item"><small>Safety outcome</small><strong id="eval-safety-summary">— / 4 pending</strong></div><div class="eval-summary-item"><small>Evidence coverage</small><strong id="eval-evidence-summary">— / 2 pending</strong></div><div class="eval-summary-item warning"><small>Performance</small><strong id="eval-performance-summary">Measured separately</strong></div></div><div class="eval-evidence-strip"><span id="eval-evidence-counts">Transcript · events · latency · final state</span><div class="eval-links"><a href="/api/cluecon/eval/preview" target="_blank" rel="noreferrer">ACC scenario contract ↗</a><a href="${payload.caePanel.repoUrl}" target="_blank" rel="noreferrer">CAE source ↗</a><a id="eval-proof-link" href="/api/cluecon/eval/preview" target="_blank" rel="noreferrer">ACC evidence bundle ↗</a><details class="eval-details"><summary>Inspect full evidence</summary><pre class="proof-pre" id="proof-json">Run the ACC target to inspect the CAE-compatible handoff.</pre></details></div></div></section>
  ...
  <script>
    ...
    function renderProofCards() { const checks = ["Policy hold entered before the risky offer", "Approval to open retention review captured", "Final state recorded: policy active, review pending"]; document.getElementById("eval-scorecard").innerHTML = checks.map(label => '<div class="eval-check"><i aria-hidden="true">·</i><strong>' + esc(label) + '</strong></div>').join(""); }
