...
function buildBasePayload(
  ...
  return {
    ...
    ttsPanel: {
      ...
      metricDefinition: "HTTP TTFB stops at first provider bytes; playback latency stops when the browser emits the playing event.",
      candidates: [
        {
          name: "Kokoro 82M",
