...
function buildBasePayload(
  ...
  return {
    ...
    title: "Voice Agent Reliability Reference Stack: Browser, Fixtures, and SIP as Adapters",
    thesis:
      "ACC integrates the demo and proof surface without owning ConversationAgentEvals, rtc-asr, or ASSERT. Browser WebRTC, fixture/tester injection, and SIP/FreeSWITCH enter the shared Pipecat media contract as adapters.",
    architectureCenter: {
    ...
    demoGoal: {
      issue: "agonza1/agentic-contact-center#307",
      statement: "Show ACC as the WebRTC.ventures Voice Agent Reliability Reference Stack while keeping ConversationAgentEvals, rtc-asr, and ASSERT as external owners.",
    ...
    securityPanel: {
      ...
      trustBoundary: "Run transcript classification and deterministic redaction inside the controlled realtime boundary before any third-party LLM handoff.",
...
<body class="${bodyClass}">
  ...
  <script>
    ...
    const state = { slide: 0, slideCount: slideOrder.length, isPresent: document.body.classList.contains("present"), proof: null, brain: JSON.parse(JSON.stringify(data.brainBlocks)), brainSession: null, asrCapture: null, asrStopping: false, asrModels: [], asrLive: null, failureAudio: null, vad: null, vadStarting: false, vadStartToken: 0, vadPendingStream: null, vadBotSpeaking: false, vadBotTimer: null, vadTurnTimer: null, vadOutputTimer: null, vadOutputCleanupTimer: null, vadSimulationTimers: [] };
