...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (min-width: 921px) { .present .voice-origin__content { padding-top: clamp(60px,7.5vh,84px); } }
    ...
    .voice-origin__turn strong { display: grid; max-width: 760px; color: #fff; font-family: "Arial Narrow", "Aptos Narrow", Inter, ui-sans-serif, system-ui, sans-serif; font-size: clamp(25px,2.45vw,38px); font-weight: 800; line-height: 1.02; letter-spacing: -.03em; text-shadow: 0 3px 24px rgba(0,0,0,.72); }
    .voice-origin__turn strong > span { display: block; color: inherit; font-size: inherit; font-weight: inherit; letter-spacing: inherit; text-transform: none; white-space: nowrap; }
