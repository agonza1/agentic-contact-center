...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .eval-progression { display: grid; grid-template-columns: repeat(4,minmax(0,1fr)); gap: 24px; }
...
def collect_identity_node() -> NodeConfig:
    ...
    <section class="section-band slide" data-slide="13" id="proof"><div class="eval-head"><div><span class="kicker">ConversationAgentEvals · compatible handoff</span><h2>One call becomes a repeatable safety test.</h2><p class="subhead">Run the cancellation scenario, verify the policy boundary, and preserve the evidence behind the verdict.</p></div><button id="run-eval" type="button" class="primary">Generate evaluation bundle</button></div><div class="eval-progression" aria-label="Evaluation progression"><div class="eval-step"><small>1 · Scenario</small><strong>Cancellation rescue</strong><span>defined</span></div><div class="eval-step"><small>2 · Simulated call</small><strong id="eval-turn-step">— turns</strong><span>repeatable</span></div><div class="eval-step"><small>3 · Policy checks</small><strong id="eval-safety-step">— / 4</strong><span>deterministic</span></div><div class="eval-step"><small>4 · Verdict</small><strong id="eval-verdict-step">ready</strong><span>reviewable</span></div></div><div class="eval-main"><article class="eval-verdict" id="eval-verdict"><small>Safety verdict</small><b id="eval-verdict-label">READY</b><strong id="eval-verdict-title">Run the safety test.</strong><p id="eval-verdict-detail">The local ACC run will produce a safety scorecard and a CAE-compatible evaluation handoff.</p></article><div class="eval-checks" id="eval-scorecard" aria-label="Checks supporting the verdict"></div></div><div class="eval-summary"><div class="eval-summary-item"><small>Safety outcome</small><strong id="eval-safety-summary">— / 4 pending</strong></div><div class="eval-summary-item"><small>Evidence coverage</small><strong id="eval-evidence-summary">— / 2 pending</strong></div><div class="eval-summary-item warning"><small>Performance</small><strong id="eval-performance-summary">Measured separately</strong></div></div><div class="eval-evidence-strip"><span id="eval-evidence-counts">Transcript · events · latency · final state</span><div class="eval-links"><a href="/api/cluecon/eval/preview" target="_blank" rel="noreferrer">Scenario contract ↗</a><a href="${payload.caePanel.repoUrl}" target="_blank" rel="noreferrer">CAE source ↗</a><a id="eval-proof-link" href="/api/cluecon/eval/preview" target="_blank" rel="noreferrer">Evaluation bundle ↗</a><details class="eval-details"><summary>Inspect full evidence</summary><pre class="proof-pre" id="proof-json">Generate the evaluation bundle to inspect the full handoff.</pre></details></div></div></section>
