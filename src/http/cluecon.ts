...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .voice-origin__turn strong { color: #fff; font-family: "Arial Narrow", "Aptos Narrow", Inter, ui-sans-serif, system-ui, sans-serif; font-size: clamp(22px,2.15vw,33px); font-weight: 800; line-height: 1.04; letter-spacing: -.025em; text-shadow: 0 3px 24px rgba(0,0,0,.62); }
