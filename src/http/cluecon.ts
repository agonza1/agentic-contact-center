...
def collect_identity_node() -> NodeConfig:
  ...
  <script>
    ...
    async function startAsrRealtime() {
      ...
      socket.addEventListener("message", handleAsrRealtimeMessage);
