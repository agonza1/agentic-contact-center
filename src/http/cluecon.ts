...
<body class="${bodyClass}">
  ...
  <main>
    ...
    <section class="section-band slide" data-slide="6" id="asr-architecture"><span class="kicker">Live ASR · app flow</span><h2>Audio in. Transcript events out.</h2><div class="asr-app-flow" aria-label="Pipecat, FreeSWITCH, or another WebRTC media server sends PCM audio over WebSocket to rtc-asr, which uses a swappable local model and returns transcript events"><div class="asr-app-node"><small>Media edge</small><strong>Pipecat</strong><span>FreeSWITCH · any WebRTC media server</span><code>PCM → WebSocket</code></div><div class="asr-app-link"><span>80–160 ms PCM16</span><b>→</b><em>partial · final · cancel</em><b>←</b></div><div class="asr-app-node asr-app-node--service"><small>Local STT v1</small><strong>rtc-asr</strong><span>persistent WebSocket</span><div class="asr-service-contract"><span>normalize</span><span>route</span><span>measure</span></div></div><div class="asr-app-link"><span>same contract</span><b>↔</b><em>warmed</em></div><div class="asr-app-node"><small>Local model</small><strong>Parakeet</strong><span>Whisper · Qwen · Voxtral</span><code>swap backend</code></div></div><div class="asr-benefits" aria-label="rtc-asr benefits"><div class="asr-benefit"><b>1</b><span><strong>Local</strong><small>no provider hop</small></span></div><div class="asr-benefit" style="--benefit-color:#2457a6"><b>2</b><span><strong>Swappable</strong><small>one contract</small></span></div><div class="asr-benefit" style="--benefit-color:#7c3aed"><b>3</b><span><strong>Realtime</strong><small>partial + final</small></span></div><div class="asr-benefit" style="--benefit-color:#9a5b04"><b>4</b><span><strong>Measurable</strong><small>latency + RTF</small></span></div></div></section>
