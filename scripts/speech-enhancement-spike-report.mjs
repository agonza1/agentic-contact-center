...
function buildMarkdownReport(artifact) {
  ...
  return [
    ...
    `- Strict artifact source count: ${artifact.strictArtifactVerification.sourceCount}`,
    `- Strict artifact verified source count: ${artifact.strictArtifactVerification.verifiedSourceCount}`,
    `- Strict artifact unverified source count: ${artifact.strictArtifactVerification.unverifiedSourceCount}`,
