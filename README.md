...
- filterable event-trail evidence at `GET /api/calls/:callId/events` with optional `?type=caller_turn_appended`, `?since=...`, and `?offset=0&limit=25` for lightweight QA and operator audit polling
